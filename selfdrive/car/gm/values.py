...
class CAR(Platforms):
  ...
  CHEVROLET_SILVERADO_TRAILER = GMPlatformConfig(
    [
      GMCarDocs("Chevrolet Silverado Trailer", "Driver Alert Package II", video_link="https://youtu.be/5HbNoBLzRwE"),
    ],
...
CAMERA_ACC_CAR = {CAR.CHEVROLET_BOLT_EUV, CAR.CHEVROLET_SILVERADO, CAR.CHEVROLET_SILVERADO_TRAILER, CAR.CHEVROLET_EQUINOX, CAR.CHEVROLET_TRAILBLAZER, CAR.CHEVROLET_TRAX}
