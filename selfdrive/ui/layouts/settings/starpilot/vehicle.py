  ...
  def _build_driving_toggles(self) -> list[dict]:
    ...
    if cs.isEV9:
      toggles.extend([{
        ...
        "key": "KiaEv9ClusterBsmReconstructionEnabled",
        ...
        "get_state": lambda: self._controller._params.get_bool("KiaEv9ClusterBsmReconstructionEnabled"),
        "set_state": lambda s: self._controller._on_toggle("KiaEv9ClusterBsmReconstructionEnabled"),
      }, {
