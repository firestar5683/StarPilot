...
function settingsAnchor(key) {
  if (key.startsWith("__starpilot_favorite_action__:longitudinal_") || ["ExperimentalMode", "ConditionalExperimental", "ConditionalChill"].includes(key)) return LONGITUDINAL_MODE_KEY
