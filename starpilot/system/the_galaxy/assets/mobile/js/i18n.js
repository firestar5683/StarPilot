...
const MORE_TRANSLATIONS = {
  ...
  vi: {
    ...
    Storage: "Bộ nhớ", "Your device": "Thiết bị của bạn", Vitals: "Trạng thái thiết bị", Software: "Phần mềm",
    ...
    "Highest streak": "Chuỗi dài nhất", "Longest undistracted drive": "Chuyến tập trung dài nhất", "Clean-drive streak": "Chuỗi chuyến lái tập trung",
    ...
    Branch: "Nhánh", Build: "Bản dựng", Commit: "Commit", "Version date": "Ngày phiên bản",
    ...
    "Capture Log": "Lưu nhật ký hiện tại", "Current session captured!": "Đã lưu nhật ký phiên hiện tại!", "Capture failed.": "Không thể lưu nhật ký.",
    ...
    "Vehicle fault status unavailable.": "Không thể đọc trạng thái lỗi của xe.", Snapshot: "Dữ liệu ghi nhận",
    ...
    "No matching processes.": "Không tìm thấy tiến trình phù hợp.", Running: "Đang chạy", Sleeping: "Đang chờ",
    Waiting: "Đang chờ", Stopped: "Đã dừng", Tracing: "Đang theo dõi", Zombie: "Zombie", Idle: "Nhàn rỗi",
    "overall usage": "mức sử dụng tổng", cores: "nhân", total: "tổng", Uptime: "Thời gian hoạt động",
    ...
    Successful: "Thành công", "Not mapped": "Chưa gán", "External input": "Thiết bị nhập ngoài",
...
const TERM_TRANSLATIONS = {
  ...
  vi: {
    ...
    "duration": "thời lượng", "analyzing": "đang phân tích", "speed": "tốc độ", "Pending": "Đang chờ", "Excluded": "Đã loại",
    "segments": "đoạn", "unknown": "không rõ", "used of": "đã dùng trên", "Online": "Trực tuyến", "Offline": "Ngoại tuyến",
    ...
    "Yes": "Có", "No": "Không", "Copy": "Sao chép", "Running": "Đang chạy", "Sleeping": "Đang chờ", "Waiting": "Đang chờ",
    "Stopped": "Đã dừng", "Idle": "Nhàn rỗi", "Memory": "Bộ nhớ", "Processes": "Tiến trình", "Process": "Tiến trình", "User": "Người dùng",
  },
}
