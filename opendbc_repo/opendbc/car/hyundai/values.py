...
# Cluster DTE validated on public route segments for these classic CAN EVs.
CAN_EV_CLUSTER_DTE_CAR = {
  CAR.HYUNDAI_IONIQ_EV_2020,
  CAR.HYUNDAI_KONA_EV,
  CAR.HYUNDAI_KONA_EV_2022,
}
# Shared SOC and DTE messages validated across these CAN-FD EV platforms.
...
CANFD_EV_CHARGING_TELEMETRY_CAR = {CAR.KIA_EV9}
...
CANFD_SECURITYACCESS_CAR = {CAR.HYUNDAI_IONIQ_5, CAR.HYUNDAI_IONIQ_6, CAR.HYUNDAI_KONA_EV_2ND_GEN, CAR.KIA_EV9}
CANFD_UNSUPPORTED_LONGITUDINAL_CAR = (
  CAR.with_flags(HyundaiFlags.CANFD_NO_RADAR_DISABLE) - CANFD_SECURITYACCESS_CAR
)  # TODO: merge with UNSUPPORTED_LONGITUDINAL_CAR
CANFD_ANGLE_LONGITUDINAL_CAR = {CAR.KIA_EV9}
CANFD_RADAR_LIVE_LONGITUDINAL_CAR = {CAR.HYUNDAI_IONIQ_5, CAR.HYUNDAI_IONIQ_6, CAR.KIA_EV6, CAR.KIA_EV9,
                                     CAR.GENESIS_GV60_EV_1ST_GEN}
