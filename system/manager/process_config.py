...
procs += [
  ...
  PythonProcess("uniden_radar_d", "starpilot.system.uniden_radar_d", always_run, enabled=TICI, nice=15),
  PythonProcess("road_alerts_d", "starpilot.system.road_alerts_d", always_run, enabled=TICI, nice=15),
