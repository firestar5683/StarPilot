...
P=Path(__file__).resolve().parent;R=P.parents[1];sys.path.insert(0,str(R/'prototype'));sys.path.insert(0,str(R/'prototype'))
from musical_gestures_v3 import MusicalGestures as V3
from musical_gestures_v4 import MusicalGestures as V4
from musical_gestures_v2 import MusicalGestures as V2
O=R/'results/ace_demo_20260916/gestures';O.mkdir(parents=True,exist_ok=True)
...
reports={}
for version,cls in [('v3',V3),('v4',V4)]:
