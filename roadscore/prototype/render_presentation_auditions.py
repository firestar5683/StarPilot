...
def main():
 ...
 arms={k:[] for k in ['core','shaker_provisional128','shaker_confidence_gated','engagement_separate','apex_separate_provisional128']};timings=[]
