...
for name in ['summary.json','jobs.jsonl','boundaries.jsonl','ending.json','bridge.json','trace.jsonl','runtime_manifest.json','song_form.json','gesture_grid.json','gestures.json','shaker_grid.json','shaker_events.json','core_apex_events.json','rhythm_timeline.json','alert_accent_events.json','output_device.json','dry.wav','audio_blocks.jsonl','composition.json','quality_events.jsonl']:
