...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"KiaEv9LongitudinalTestEnabled", {PERSISTENT, BOOL, "0"}},
    {"KiaEv9LongitudinalTestStage", {PERSISTENT, INT, "0", "0"}},
    {"KiaEv9LongitudinalProbeMode", {PERSISTENT, INT, "0", "0"}},
    {"KiaEv9DtcCaptureEnabled", {PERSISTENT, BOOL, "0"}},
    {"KiaEv9CruiseMainStateEnabled", {PERSISTENT, BOOL, "1"}},
    {"KiaEv9SoftDriverSteeringOverrideEnabled", {PERSISTENT, BOOL, "1"}},
    ...
    {"KiaEv9ClusterObjectsOnMainEnabled", {PERSISTENT, BOOL, "1"}},
    {"KiaEv9ClusterAlternateLeadEnabled", {PERSISTENT, BOOL, "0"}},
    {"KiaEv9ClusterFusedPrimaryRequired", {PERSISTENT, BOOL, "1"}},
    {"KiaEv9ClusterSideObjectsRequireBsmEnabled", {PERSISTENT, BOOL, "0"}},
    {"KiaEv9ClusterStrictSideObjectFilterEnabled", {PERSISTENT, BOOL, "1"}},
    {"KiaEv9ClusterRightObjectsEnabled", {PERSISTENT, BOOL, "0"}},
    ...
    {"KiaEv9RawBsmReconstructionEnabled", {PERSISTENT, BOOL, "0"}},
    {"KiaEv9RearBsmClusterFallbackEnabled", {PERSISTENT, BOOL, "0"}},
    {"KiaEv9SoftwareBsmEnabled", {PERSISTENT, BOOL, "0"}},
