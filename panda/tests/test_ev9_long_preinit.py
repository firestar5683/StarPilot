...
def test_firmware_usb_gate_blocks_disruptive_mutations_until_release():
  ...
  for request, param1, param2 in (
    ...
    (0xDC, 28, 0x495), (0xDC, 36, 0x494), (0xDE, 0, 2500),
  ...
  assert lpp.ev9_test_usb_request_allowed(0xDC, 36, 0x495)
  assert lpp.ev9_test_usb_request_allowed(0xDC, 36, 0xC95)
  assert lpp.ev9_test_usb_request_allowed(0xE7, 0, 0)
  assert lpp.ev9_test_preserve_can_on_safety_transition(36, 0x495)
  assert not lpp.ev9_test_preserve_can_on_safety_transition(36, 0x494)
  assert not lpp.ev9_test_preserve_can_on_safety_transition(28, 0x495)
...
def test_host_watchdog_loss_after_handoff_does_not_restart_resident_bridge():
  enter_handoff()
  assert lpp.set_safety_hooks(36, 0x495) == 0
